...
wget https://raw.githubusercontent.com/ESGuardian/LittleBeat/master/addons/littlebeat_5.5.001_addons.sh >/dev/nul 2>&1
...
bash $homedir/addons/littlebeat_5.5.001_addons.sh
