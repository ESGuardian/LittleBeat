...
class Config(object):
    ...
    # given file.
    DOORMAN_LOG_FILE_PLUGIN_JSON_LOG = '/var/log/doorman/osquery.log'     # Default: do not log status/results to json log
...
class ProdConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = 'postgresql://doorman:7aWNLur6dyy97LYylawz@127.0.0.1:5432/doorman'

    DOORMAN_ENROLL_SECRET = ['w3qBDdXZDvOsd47RK5zx']
